...
//            val coordinate: Coordinate = city.coordinate
...
//
//    @RequiresApi(Build.VERSION_CODES.O)
//    private fun fetchCurrentWeatherByCoordinate(coordinate: Coordinate) {
...
//
//        viewModelScope.launch {
//            when (val queryResult = repository.requestCurrentWeatherByCoordinate(coordinate = coordinate)) {
...
//        viewModelScope.launch {
//            when (val queryResult = repository.requestCurrentWeatherByZipCode(zipcode)) {
//                is QueryResponseState.Success -> {
//                    _currentWeatherState.value = CurrentWeatherState.Success(queryResult.data)
