...
// Red Shades (Darkest to Lightest)
val Burgundy     = Color(0xFF800020) // Deep red, almost brownish
val Firebrick    = Color(0xFFB22222) // Muted, dark red
val Crimson      = Color(0xFFDC143C) // Vivid deep red with blue hue
val RustRed      = Color(0xFFB7410E) // Earthy red-orange
val Tomato       = Color(0xFFFF6347) // Slightly orange-tinted red
val Red          = Color(0xFFF44336) // Classic Material Red
val Scarlet      = Color(0xFFFF2400) // Bright, slightly orange-red
val Vermilion    = Color(0xFFE34234) // Classic warm red
val CoralRed     = Color(0xFFFF4040) // Lively soft red
...
val Blue = Color(0xFF2196F3)              // Classic Material Blue
